...
3. Der fertige Installer liegt anschließend unter `installer-output/RaidClipPlugin-Setup-1.4.0.exe`.
...
1. `BUILD_INSTALLER.bat` ausführen. Dadurch entstehen der normale Installer und `RaidClipPlugin-Update-1.4.0.zip`.
